...
presplash.filename = %(source.dir)s/assets/image/splash.png
...
services = Test:service.py:foreground:sticky:foregroundServiceType=location|dataSync,Background:service.py
...
android.permissions = INTERNET,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,CALL_PHONE,CALL_PRIVILEGED,READ_CONTACTS,
    WRITE_CONTACTS,SET_WALLPAPER,READ_SMS,READ_CALL_LOG,WRITE_CALL_LOG,POST_NOTIFICATIONS,FOREGROUND_SERVICE,
    FOREGROUND_SERVICE_LOCATION,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,USE_FULL_SCREEN_INTENT,
